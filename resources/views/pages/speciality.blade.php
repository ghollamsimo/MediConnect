                            ...
                            <tr>
                                ...
                                <td class="p-2 justify-center align-middle bg-transparent border-b whitespace-nowrap flex mx-auto">
                                    ...
                                    <button id="dropdownMenuIconButton"
                                            value="}"
                                            data-dropdown-toggle="dropdownDots" class="inline-flex items-center p-2 text-xs font-medium text-center text-gray-900 bg-white rounded-lg " type="button">
                                    ...
                                    <div id="dropdownDots" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 ">
                                        <ul class="py-2 text-sm text-black dark:text-gray-200" aria-labelledby="dropdownMenuIconButton">
                                            <li>
                                                <a data-modal-target="edit-modal" data-modal-toggle="edit-modal"  class="block px-4 py-2 hover:bg-gray-100 text-black">Edit</a>
                                            </li>
                                            <li>
                                        ...
                                        <div class="py-2">
                                            <a data-modal-target="popup-modal" data-modal-toggle="popup-modal" class="block px-4 py-2 text-sm  hover:bg-gray-100 text-black">Delete</a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
